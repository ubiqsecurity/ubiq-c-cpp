...
class cpp_structured_encrypt_2 : public ::testing::Test
{
public:
    void SetUp(void);
    void TearDown(void);
...
void cpp_structured_encrypt_2::SetUp(void)
{
    ASSERT_TRUE((bool)_creds);
}

void cpp_structured_encrypt_2::TearDown(void)
{
}

TEST_F(cpp_structured_encrypt_2, none)
{
  ASSERT_NO_THROW(
...
TEST_F(cpp_structured_encrypt_2, bulk)
{
...
TEST_F(cpp_structured_encrypt_2, bulk_search)
{
  std::string ffs_name("ALPHANUM_SSN");
  std::string pt("0123456789");
...
TEST_F(cpp_structured_encrypt_2, invalid_ffs)
{
...
TEST_F(cpp_structured_encrypt_2, invalid_creds)
{
  std::string ffs_name("ALPHANUM_SSN");
  std::string pt("ABCDEFGHI");
  std::string ct;
...
TEST_F(cpp_structured_encrypt_2, invalid_PT_CT)
{
...
TEST_F(cpp_structured_encrypt_2, invalid_LEN)
{
  std::string ffs_name("SSN");
...
TEST_F(cpp_structured_encrypt_2, invalid_specific_creds)
{
  std::string ffs_name("ALPHANUM_SSN");
  std::string pt("123456789");
  std::string ct;
...
TEST_F(cpp_structured_encrypt_2, invalid_keynum)
{
  std::string ffs_name("SSN");
  std::string pt("0123456789");
  std::string ct;
...
TEST(c_structured_encrypt_2, piecewise)
{
...
TEST(c_structured_encrypt_2, piecewise_search)
{
    static const char * const pt = ";0123456-789ABCDEF|";
//    static const char * const pt = "00001234567890";//234567890";
    static const char * const ffs_name = "ALPHANUM_SSN";
...
TEST(c_structured_encrypt_2, 10_cycles)
{
    static const char * const pt = ";0123456-789ABCDEF|";
//    static const char * const pt = "00001234567890";//234567890";
    static const char * const ffs_name = "ALPHANUM_SSN";
...
TEST(c_structured_encrypt_2, error_handling_null_object)
{
  int err_num;
  char * err_msg = NULL;
  int res;
...
TEST(c_structured_encrypt_2, error_handling_notnull_object)
{
  int err_num;
  char * err_msg = NULL;
  int res;
...
TEST(c_structured_encrypt_2, error_handling_invalid_ffs)
{
...
TEST(c_structured_encrypt_2, error_handling_invalid_creds)
{
...
TEST(c_structured_encrypt_2, error_handling_invalid_PT_CT)
{
...
TEST(c_structured_encrypt_2, error_handling_invalid_LEN)
{
...
TEST(c_structured_encrypt_2, error_handling_invalid_papi)
{
    static const char * const pt = ";0123456-789ABCDEF|";
    static const char * const ffs_name = "ALPHANUM_SSN";
...
TEST(c_structured_encrypt_2, error_handling_invalid_sapi)
{
    static const char * const pt = ";0123456-789ABCDEF|";
    static const char * const ffs_name = "ALPHANUM_SSN";
...
TEST(c_structured_encrypt_2, error_handling_invalid_rsa)
{
    static const char * const pt = ";0123456-789ABCDEF|";
    static const char * const ffs_name = "ALPHANUM_SSN";
...
TEST(c_structured_encrypt_2, error_handling_invalid_host)
{
    static const char * const pt = ";0123456-789ABCDEF|";
    static const char * const ffs_name = "ALPHANUM_SSN";
...
TEST(c_structured_encrypt_2, error_handling_invalid_keynum)
{
...
TEST_F(cpp_structured_encrypt_2, 1m)
{
  std::string ffs_name("ALPHANUM_SSN");
  std::string pt("0123456789");
  std::string ct, ct2;
...
TEST(c_structured_encrypt_2, new)
{
    static const char * const pt = ";0123456-789ABCDEF|";
    static const char * const ffs_name = "ALPHANUM_SSN";
...
TEST(c_structured_encrypt_2, prealloc)
{
    static const char * const pt = ";0123456-789ABCDEF|";
    static const char * const ffs_name = "ALPHANUM_SSN";
...
TEST(c_structured_encrypt_2, prealloc_complex)
{
